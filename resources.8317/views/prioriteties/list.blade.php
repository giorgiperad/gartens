...
<div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
  <div class="mb-6">
    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white tracking-tight">პრიორიტეტი</h1>
  </div>
 ...
 <section class="content">
  ...
  <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md rounded-xl overflow-hidden">
    <div class="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      <h3 class="text-lg font-bold text-gray-900 dark:text-white">პრიორიტეტების ჩამონათვალი</h3>
      <div>
        <button 
          type="submit" onclick="location.href = '{{ route('prioriteties.show') }}'" class="bg-indigo-700 hover:bg-indigo-800 text-white font-medium px-4 py-2 rounded-lg shadow transition-all text-sm">
      ...
      <table class="w-full text-center">
        <thead class="bg-gray-100 dark:bg-gray-800">
          <tr>
            ...
            <th class="px-4 sm:px-6 py-3 text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">პრიორიტეტი</th>
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          @foreach ($model as $item)
           <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            ...
            <td class="px-4 sm:px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{$item->name}}</td>
