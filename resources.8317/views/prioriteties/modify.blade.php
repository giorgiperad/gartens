      ...
      <div class="p-4 sm:p-6">
        <div class="flex flex-col lg:flex-row gap-6">
          <div class="flex-1 order-2 lg:order-1">
            <div class="tab-content" id="custom-tabs-three-tabContent">
             ...
             <div class="form-group">
			    {!! Form::label('name', 'პრიორიტეტის დასახელება', ['class' => 'block text-sm font-semibold text-gray-900 dark:text-white mb-2']) !!}
          ...
          <div class="w-full lg:w-80 order-1 lg:order-2">
            <button onclick="location.href = '{{ route('prioriteties.list') }}'" type="button" class="w-full bg-red-600 hover:bg-red-700 text-white font-medium px-6 py-3 rounded-lg shadow transition-all mb-3">
