 ...
 <section class="content">
  ...
  <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md rounded-xl overflow-hidden">
    <div class="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      ...
      <div>
        <button 
          type="submit" onclick="location.href = '{{ route('regions.show') }}'" class="bg-indigo-700 hover:bg-indigo-800 text-white font-medium px-4 py-2 rounded-lg shadow transition-all text-sm">
           ...
           <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            ...
            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm">
              <button 
                ...
                onclick="location.href = '{{route('regions.show', ['id' => $item->id])}}'">
              ...
              <button 
                ...
                data-href="{{route('regions.destroy', ['id' => $item->id])}}"
