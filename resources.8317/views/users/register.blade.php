        ...
        <div class="flex flex-col lg:flex-row gap-6">
          <div class="flex-1 order-2 lg:order-1">
            ...
            <div class="mb-4">
                            ...
                            <div>
                                <input id="name" type="text" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-700 focus:border-indigo-700 @error('name') border-red-500 @enderror" name="name" value="{{ old('name') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div>
                                <input id="email" type="email" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-700 focus:border-indigo-700 @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}">
