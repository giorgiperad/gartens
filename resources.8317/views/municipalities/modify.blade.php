      ...
      <div class="p-4 sm:p-6">
        <div class="flex flex-col lg:flex-row gap-6">
          <div class="flex-1 order-2 lg:order-1">
            <div class="mb-4">
             <div class="form-group">
			    {!! Form::label('name', 'დასახელება', ['class' => 'block text-sm font-semibold text-gray-900 dark:text-white mb-2']) !!}
          ...
          <div class="w-full lg:w-80 order-1 lg:order-2">
            <div class="mb-4">
            {!! Form::select('region_id', $data['regions'], null, ['class' => 'w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-700 focus:border-indigo-700', 'placeholder' => 'აირჩიეთ რეგიონი']) !!}
            </div>
            <button onclick="location.href = '{{ route('municipalities.list') }}'" type="button" class="w-full bg-red-600 hover:bg-red-700 text-white font-medium px-6 py-3 rounded-lg shadow transition-all mb-3">
